...
<head>            
      ...
      <link rel="stylesheet" type ="text/css" href="Biriyani.css">
...
<body>
	...
	<!-- Image Slider for Home Page Ends Here -->
					...
					<?php
				$query = "SELECT * FROM Biriyani ORDER BY id ASC";
				...
				?>
			<div class="col-md-3">
				<form method="post" action="Biriyani.php?action=add&id= <?php echo $row["id"]; ?>">
							<div class="probox">
