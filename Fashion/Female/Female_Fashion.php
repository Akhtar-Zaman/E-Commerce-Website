...
<head>            
      ...
      <link rel="stylesheet" type ="text/css" href="Female_Fashion.css">
...
<body>
	...
	<!-- Image Slider for Home Page Ends Here -->
					...
					<?php
				$query = "SELECT * FROM female ORDER BY id ASC";
				...
				?>
			<div class="col-md-3">
				<form method="post" action="Female_Fashion.php?action=add&id= <?php echo $row["id"]; ?>">
						<div class="probox">
