...
<body>
	...
	<script>
					var img= [ "Slider images/bcd.jpg",			                   
							   "Slider images/Untitled-4.jpg",
							   "Slider images/Untitled-5.jpg"
							 ];
						  ...
						  function slides()
						  {
						         ...
						         setInterval(slides,2000)
											...
											<div id="slider">		 
												   <img src="Slider images/bcd.jpg" id="bal" />		 
											</div>
	...
	<!-- Image Slider for Home Page Ends Here -->
					...
					<h3 align= "center"> 30% Discount Running </h3>
					<br> <br>
					...
					<!-- php -->
					<?php
				$query = "SELECT * FROM discount_offer ORDER BY id ASC";
